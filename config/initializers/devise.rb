...
# require "omniauth-twitter" # Commented out for production deployment
...
Devise.setup do |config|
  ...
  config.secret_key = ENV.fetch("DEVISE_SECRET_KEY", ENV.fetch("SECRET_KEY_BASE", "development-secret-key-change-in-production"))
